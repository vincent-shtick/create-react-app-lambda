...
class DetailHotelView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/DetailHotelController')
  ...
  render() {
    const proxies = Controller !== DetailHotelView ? transformProxies(this.props.children) : {
              ...
              <div className="af-class-container">
                <div className="af-class-features-grid">
                  <div className="af-class-feature">
                    <div className="af-class-feature-img"><img src="images/Brugge-web.jpg" alt /></div>
                  ...
                  <div className="af-class-feature">
                    ...
                    <div className="af-class-feature-img af-class-feature-left"><img src="images/Brugge-web.jpg" alt /></div>
                  </div>
                  <div className="af-class-feature">
                    <div className="af-class-feature-img"><img src="images/Brugge-web.jpg" alt /></div>
                    <div className="af-class-feature-text">
                ...
                <div className="af-class-regio">
                  ...
                  <div className="af-class-regio-item">
                    <div className="af-class-regio-img">
                      <div className="af-class-regio-img-big"><img src="images/Brugge-web.jpg" alt className="af-class-regio-big-image" /></div><img src="images/ruit.png" alt className="af-class-regio-ruit" /></div>
...
export default DetailHotelView
